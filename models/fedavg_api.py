...
class FedAvgAPI(object):
    def __init__(self, dataset: FedDatasetCV, model_trainer, p_args):
        ...
        self.client_list = []
        _, self.train_data_local_num_dict = dataset.get_class_cound_list()
        self.train_data_local_dict = train_data_local_dict
        self.test_data_local_dict = test_data_local_dict

        self.model_trainer = model_trainer
        self._setup_clients(self.train_data_local_num_dict, train_data_local_dict, test_data_local_dict, model_trainer)
    ...
    def _setup_clients(self, train_data_local_num_dict, train_data_local_dict, test_data_local_dict, model_trainer):
        ...
        for client_idx in range(self.args.n_client_per_round):
            c = Client(client_idx, train_data_local_dict[client_idx], test_data_local_dict[client_idx],
                       train_data_local_num_dict[client_idx], self.args, self.args.device, model_trainer)
